...
class MainViewModel : ViewModel() {
    ...
    fun init() {
        ...
        ethereumKit = EthereumKit.getInstance(App.instance, privateKey, EthereumKit.SyncMode.GethSyncMode(), networkType, infuraCredentials, etherscanKey, "unique-wallet-id")
