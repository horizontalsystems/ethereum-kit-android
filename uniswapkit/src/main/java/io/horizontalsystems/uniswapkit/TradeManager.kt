...
class TradeManager(
    ...
    companion object {
        ...
        private fun getRouterAddress(chain: Chain) =
            when (chain) {
                Chain.Ethereum, Chain.EthereumGoerli, Chain.EthereumSepolia -> Address("0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D")
        ...
        private fun getFactoryAddressString(chain: Chain) =
            when (chain) {
                Chain.Ethereum, Chain.EthereumGoerli, Chain.EthereumSepolia -> "0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f"
        ...
        private fun getInitCodeHashString(chain: Chain) =
            when (chain) {
                Chain.Ethereum, Chain.EthereumGoerli, Chain.EthereumSepolia, Chain.Polygon, Chain.Avalanche -> "0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f"
